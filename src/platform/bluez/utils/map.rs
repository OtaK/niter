...
pub struct ZvariantableMap<
    K: std::hash::Hash
        ...
        + zvariant::Type
        + zvariant::Basic
        + std::convert::TryFrom<zvariant::Value<'static>>
        + std::convert::TryFrom<zvariant::OwnedValue>,
    V: zvariant::Type
        + std::convert::TryFrom<zvariant::Value<'static>>
        + std::convert::TryFrom<zvariant::OwnedValue>,
>(HashMap<K, V>);
...
impl<K, V> std::convert::TryFrom<zvariant::OwnedValue> for ZvariantableMap<K, V>
where
    K: std::hash::Hash
        + Eq
        + zvariant::Type
